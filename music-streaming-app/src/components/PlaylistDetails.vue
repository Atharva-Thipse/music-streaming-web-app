<template>
      ...
      <div class="card ms-3" style="width: 1400px; height: 500px;">
        <div v-for="song in playlist" :key="song[0]">
          <div class="row card m-2" style="height: 49px;">
            <div class="col-md-6 d-flex">
                    ...
                    <div>
                        <p class="mt-3 ms-2" style="font-size: 14px;">{{ song[3] }} | {{ song[4] }}</p>
                    </div>
                  </div>
                    <div class="col-md-6 d-flex justify-content-end mt-1 p-0">
                        <button style="width: 200px;" class="btn btn-info text-center me-2" type="submit"><router-link class="text-decoration-none text-dark" :to="'/song/' + song[1]">View Details</router-link></button>
...
export default {
    ...
    methods: {
        async getData(){
            ...
            const path = `http://127.0.0.1:5000/playlist/${this.$route.params.playlist_id}`;
            try {
